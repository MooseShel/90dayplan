...
const WHY_NOW = [
  ...
  { trigger: 'Labor Shortage', icon: '👷', detail: 'The average upstream geoscientist is 52 years old. 40% of the workforce retires before 2030. Agentic AI that augments rather than replaces is a workforce strategy, not just an efficiency play.' },
