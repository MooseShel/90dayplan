...
// ═══════════════════════════════════════════════════════════════════════
// ── REFERENCES & SOURCE ARCHIVE REGISTRY ─────────────────────────────
// ═══════════════════════════════════════════════════════════════════════

export const REFERENCES_REGISTRY = {
  "REF-01": {
    id: "REF-01",
    title: "IEA World Energy Outlook 2025",
    publisher: "International Energy Agency (IEA)",
    pubDate: "2025-10-15",
    liveUrl: "https://www.iea.org/topics/world-energy-outlook",
    archiveUrl: "https://web.archive.org/web/20251101/https://www.iea.org/topics/world-energy-outlook",
    htmlPath: "/references/REF-01_IEA_World_Energy_Outlook.html",
    mdPath: "/references/REF-01_IEA_World_Energy_Outlook.md",
    statusText: "Protected / Verified via Archive Copy",
    summary: "The IEA World Energy Outlook 2025 provides the authoritative benchmark for global energy market dynamics, capital expenditure flows, and decarbonization trajectories. Establishes $4.9T O&G revenue and ~18% public cloud adoption rate.",
    keyMetrics: [
      { label: "Global O&G Revenue", value: "$4.9T", desc: "Total global annual revenue generated by oil and gas operations" },
      { label: "Cloud Penetration Rate", value: "~18%", desc: "Percentage of O&G workloads running on public cloud" }
    ]
  },
  "REF-02": {
    id: "REF-02",
    ...
    pubDate: "2025-06-30",
    liveUrl: "https://www.gartner.com/en/newsroom/press-releases/gartner-forecasts-global-it-spending",
    archiveUrl: "https://web.archive.org/web/20250701/https://www.gartner.com/en/newsroom/press-releases/gartner-forecasts-global-it-spending",
    htmlPath: "/references/REF-02_Gartner_IT_Spending_Forecast.html",
    mdPath: "/references/REF-02_Gartner_IT_Spending_Forecast.md",
    statusText: "Protected / Verified via Archive Copy",
    summary: "Gartner's energy vertical market research calculates total IT expenditure across the oil and gas industry at $44 billion annually. Details market share: AWS 37%, Azure 32%, Google Cloud 10%.",
    keyMetrics: [
      { label: "O&G Sector IT Spend", value: "$44B", desc: "Annual IT & digital infrastructure expenditure" },
      { label: "GCP Market Share", value: "10%", desc: "Current Google Cloud vertical share" }
    ]
  },
  "REF-03": {
    id: "REF-03",
    ...
    pubDate: "2025-05-15",
    liveUrl: "https://www.idc.com/research",
    archiveUrl: "https://web.archive.org/web/20250601/https://www.idc.com/research",
    htmlPath: "/references/REF-03_IDC_Worldwide_Industry_Cloud_Tracker.html",
    mdPath: "/references/REF-03_IDC_Worldwide_Industry_Cloud_Tracker.md",
    statusText: "Live Site Verified (200 OK)",
    summary: "IDC forecasts the total addressable vertical cloud market will reach $21.0 billion by 2028. Maps Google-winnable SAM at $9.5B and SOM target at $3.2B.",
    keyMetrics: [
      { label: "Total Addressable Market", value: "$21.0B", desc: "Projected cloud + AI market in O&G by 2028" },
      { label: "Serviceable Addressable Market", value: "$9.5B", desc: "Google-winnable workloads" }
    ]
  },
  "REF-04": {
    id: "REF-04",
    ...
    pubDate: "2025-01-20",
    liveUrl: "https://www.precedenceresearch.com/artificial-intelligence-in-oil-and-gas-market",
    archiveUrl: "https://web.archive.org/web/20250301/https://www.precedenceresearch.com/artificial-intelligence-in-oil-and-gas-market",
    htmlPath: "/references/REF-04_Precedence_Research_AI_in_Oil_and_Gas.html",
    mdPath: "/references/REF-04_Precedence_Research_AI_in_Oil_and_Gas.md",
    statusText: "Live Site Verified (200 OK)",
    summary: "Precedence Research evaluates AI/ML solutions in oil & gas. Market is valued at $5.4B in 2024 and projected to reach $18.7B by 2035 at 13.0% CAGR.",
    keyMetrics: [
      { label: "2024 AI Market", value: "$5.4B", desc: "Global AI/ML market in O&G" },
      { label: "2035 Projection", value: "$18.7B", desc: "13.0% CAGR growth trajectory" }
    ]
  },
  "REF-05": {
    id: "REF-05",
    ...
    pubDate: "2025-03-10",
    liveUrl: "https://www.marketsandmarkets.com/report-search-page.asp?rpt=digital-oilfield-solutions-market",
    archiveUrl: "https://web.archive.org/web/20250401/https://www.marketsandmarkets.com/Market-Reports/digital-oilfield-solutions-market-528.html",
    htmlPath: "/references/REF-05_MarketsandMarkets_Digital_Oilfield.html",
    mdPath: "/references/REF-05_MarketsandMarkets_Digital_Oilfield.md",
    statusText: "Live Site Verified (200 OK)",
    summary: "Digital Oilfield solutions market stands at $37B and is projected to reach $43B by 2029 (6.3% CAGR), driven by field IoT, edge analytics, and real-time NPT optimization.",
    keyMetrics: [
      { label: "Current Market", value: "$37B", desc: "Digital oilfield valuation (2024)" },
      { label: "2029 Projection", value: "$43B", desc: "Projected market size at 6.3% CAGR" }
    ]
  },
  "REF-06": {
    id: "REF-06",
    ...
    pubDate: "2025-11-20",
    liveUrl: "https://www.globalccsinstitute.com/resources/global-status-report/",
    archiveUrl: "https://web.archive.org/web/20251201/https://www.globalccsinstitute.com/resources/global-status-report/",
    htmlPath: "/references/REF-06_Global_CCS_Institute_Status_Report.html",
    mdPath: "/references/REF-06_Global_CCS_Institute_Status_Report.md",
    statusText: "Live Site Verified (200 OK)",
    summary: "Tracks 77 operational commercial CCUS facilities, 47 under construction, and an annual investment pipeline exceeding $5B (15x expansion since 2020).",
    keyMetrics: [
      { label: "Operating Facilities", value: "77", desc: "Commercial CCUS facilities operational" },
      { label: "Annual Pipeline", value: "$5B+", desc: "Annual capital commitment to CCS" }
    ]
  },
  "REF-07": {
    id: "REF-07",
    title: "Journal of Petroleum Technology & Upstream Demographics",
    publisher: "Society of Petroleum Engineers (SPE)",
    pubDate: "2025-04-18",
    liveUrl: "https://jpt.spe.org/",
    archiveUrl: "https://web.archive.org/web/20250501/https://jpt.spe.org/",
    htmlPath: "/references/REF-07_SPE_Journal_of_Petroleum_Technology.html",
    mdPath: "/references/REF-07_SPE_Journal_of_Petroleum_Technology.md",
    statusText: "Live Site Verified (200 OK)",
    summary: "Highlights demographic challenges: upstream geoscientist average age >50, 2030 workforce retirement cliff, and 20-30 years of siloed OSDU/Petrel data per operator.",
    keyMetrics: [
      { label: "Avg Geoscientist Age", value: ">50 Yrs", desc: "Average age of technical workforce" },
      { label: "Data Fragmentation", value: "20-30 Yrs", desc: "Years of siloed data per major operator" }
    ]
  },
  "REF-08": {
    id: "REF-08",
    ...
    pubDate: "2024-09-12",
    liveUrl: "https://nca.gov.sa/",
    archiveUrl: "https://web.archive.org/web/20250101/https://nca.gov.sa/",
    htmlPath: "/references/REF-08_Saudi_NCA_Cybersecurity_Controls.html",
    mdPath: "/references/REF-08_Saudi_NCA_Cybersecurity_Controls.md",
    statusText: "Live Site Verified (200 OK)",
    summary: "NCA ECC-1:2018 and CST cloud regulations mandate Class C in-country data residency, sovereign key management (EKMS), and zero-trust security for energy critical infrastructure.",
    keyMetrics: [
      { label: "Data Residency", value: "Class C", desc: "Mandatory in-country hosting for critical data" },
      { label: "Key Security", value: "EKMS", desc: "External Key Management required" }
    ]
  },
  "REF-09": {
    id: "REF-09",
    title: "Everest Group Energy Cloud & GSI Accreditation Analysis",
    publisher: "Everest Group",
    pubDate: "2025-08-14",
    liveUrl: "https://www.everestgrp.com/reportstore/",
    archiveUrl: "https://web.archive.org/web/20250901/https://www.everestgrp.com/",
    htmlPath: "/references/REF-09_Everest_Group_Energy_Cloud_Analysis.html",
    mdPath: "/references/REF-09_Everest_Group_Energy_Cloud_Analysis.md",
    statusText: "Protected / Verified via Archive Copy",
    summary: "Evaluates cloud service providers and GSI ecosystems. Identifies that 78% of energy enterprises run multicloud architectures.",
    keyMetrics: [
      { label: "Multicloud Rate", value: "78%", desc: "Operators running multicloud environments" }
    ]
  },
  "REF-10": {
    id: "REF-10",
    title: "IEA Electricity 2024 - AI Data Center Power Forecast",
    publisher: "International Energy Agency (IEA)",
    pubDate: "2024-01-24",
    liveUrl: "https://www.iea.org/reports/electricity-2024",
    archiveUrl: "https://web.archive.org/web/20240201/https://www.iea.org/reports/electricity-2024",
    htmlPath: "/references/REF-10_IEA_Electricity_2024_Forecast.html",
    mdPath: "/references/REF-10_IEA_Electricity_2024_Forecast.md",
    statusText: "Protected / Verified via Archive Copy",
    summary: "Projects global data center power consumption to double to >1,000 TWh by 2026. Forms baseline for Project Interchange bilateral power agreements.",
    keyMetrics: [
      { label: "2026 Power Demand", value: ">1,000 TWh", desc: "Data center electricity demand doubling" }
    ]
  },
  "REF-11": {
    id: "REF-11",
    ...
    pubDate: "2023-11-10",
    liveUrl: "https://www.ipcc.ch/",
    archiveUrl: "https://web.archive.org/web/20240101/https://www.ipcc.ch/",
    htmlPath: "/references/REF-11_IPCC_Special_Report_CCS.html",
    mdPath: "/references/REF-11_IPCC_Special_Report_CCS.md",
    statusText: "Live Site Verified (200 OK)",
    summary: "Establishes scientific benchmarks for geological storage integrity (>99% retained over 1,000 years) and 4D seismic monitoring standards.",
    keyMetrics: [
      { label: "Storage Permanence", value: ">99%", desc: "CO2 retained over 1,000 years in geological formations" }
    ]
  },
  "REF-12": {
    id: "REF-12",
    ...
    pubDate: "2025-02-18",
    liveUrl: "https://www.mckinsey.com/industries/oil-and-gas/our-insights",
    archiveUrl: "https://web.archive.org/web/20250301/https://www.mckinsey.com/",
    htmlPath: "/references/REF-12_McKinsey_Energy_Insights.html",
    mdPath: "/references/REF-12_McKinsey_Energy_Insights.md",
    statusText: "Protected / Verified via Archive Copy",
    summary: "Highlights capital discipline among O&G boards. Targeted AI applications deliver 15-25% reduction in Non-Productive Time (NPT) and fast ROI.",
    keyMetrics: [
      { label: "NPT Reduction", value: "15-25%", desc: "Reduction in Non-Productive Time via AI analytics" }
    ]
  }
};

export const INDUSTRY_METRICS = [
  { label: "Global O&G Revenue",      value: "$4.9T",   sub: "Total industry revenue (2025)",            source: "IEA World Energy Outlook 2025",        refId: "REF-01", sourceUrl: "https://www.iea.org/topics/world-energy-outlook",        htmlPath: "/references/REF-01_IEA_World_Energy_Outlook.html", icon: "🛢️" },
  { label: "IT & Digital Spending",    value: "$44B",    sub: "O&G sector IT spending (2025)",             source: "Gartner IT Spending Forecast, Q2 2025", refId: "REF-02", sourceUrl: "https://www.gartner.com/en/newsroom/press-releases/gartner-forecasts-global-it-spending", htmlPath: "/references/REF-02_Gartner_IT_Spending_Forecast.html", icon: "💻" },
  { label: "Cloud Adoption Rate",     value: "~18%",    sub: "O&G workloads on public cloud",             source: "IDC Cloud Tracker, 2025",               refId: "REF-03", sourceUrl: "https://www.idc.com/research",               htmlPath: "/references/REF-03_IDC_Worldwide_Industry_Cloud_Tracker.html", icon: "☁️" },
  { label: "AI/ML Market in O&G",     value: "$5.4B",   sub: "Growing at 13% CAGR to $18.7B by 2035",    source: "Precedence Research, 2025",              refId: "REF-04", sourceUrl: "https://www.precedenceresearch.com/artificial-intelligence-in-oil-and-gas-market", htmlPath: "/references/REF-04_Precedence_Research_AI_in_Oil_and_Gas.html", icon: "🧠" },
  { label: "Digital Oilfield Market",  value: "$37B",    sub: "Projected $43B by 2029 (6.3% CAGR)",       source: "MarketsandMarkets, 2025",               refId: "REF-05", sourceUrl: "https://www.marketsandmarkets.com/report-search-page.asp?rpt=digital-oilfield-solutions-market", htmlPath: "/references/REF-05_MarketsandMarkets_Digital_Oilfield.html", icon: "📡" },
  { label: "CCUS Investment Pipeline", value: "$5B+",    sub: "Annual CCS investment (15× since 2020)",   source: "Global CCS Institute, 2025",            refId: "REF-06", sourceUrl: "https://www.globalccsinstitute.com/resources/global-status-report/", htmlPath: "/references/REF-06_Global_CCS_Institute_Status_Report.html", icon: "🌍" },
];
...
export const INDUSTRY_DRIVERS = [
  {
    ...
    source: "IEA Electricity 2024 Analysis & Forecast",
    refId: "REF-10",
  ...
  },
  {
    ...
    source: "Saudi National Cybersecurity Authority (NCA) / CST",
    refId: "REF-08",
  ...
  },
  {
    ...
    refId: "REF-12",
    sourceUrl: "https://www.mckinsey.com/industries/oil-and-gas/our-insights",
    htmlPath: "/references/REF-12_McKinsey_Energy_Insights.html"
  },
];
...
export const THINK_BIG_INITIATIVES = {
  ...
  initiatives: [
    ...
    },
    {
      ...
      consortiumFinancials: [
        { target: "ExxonMobil Gulf Coast Hub", scale: "US Gulf Coast corridor (9 → 50+ MTPA, 1,500+ mi pipeline)", partners: "ExxonMobil Low Carbon Solutions, CF Industries, Nucor", capex: "$12.0B+", directGcp: "$120M – $200M", pullThrough: "$450M+", stack: "SLB Sequestri on GCP + Gemini Pipeline Flow AI + Earth Engine MethaneSAT + BigQuery 45Q Billing. Trojan horse into ExxonMobil's enterprise cloud estate." },
        { target: "East Coast Cluster (ECC) / NEP", scale: "UK North Sea (4 → 23 MTPA by 2035; 1B tonnes storage)", partners: "BP, Equinor, TotalEnergies", capex: "$25.0B+", directGcp: "$150M – $250M", pullThrough: "$800M+", stack: "OSDU Shared Data Governance + SLB Sequestri + Earth Engine Marine Monitoring. Multi-operator wedge into BP, Equinor, and TotalEnergies." },
        { target: "Project Greensand", scale: "Denmark / EU (0.4 → 8 MTPA by 2030; EU first offshore storage)", partners: "INEOS Energy, Harbour Energy", capex: "$3.8B", directGcp: "$45M – $80M", pullThrough: "$150M+", stack: "INEOS GCP Platform + Carbon Destroyer Shipping Optimization + EU CCS Compliance Agents. Reference blueprint for 30+ upcoming EU CCS hubs." },
        { target: "Consortium Total & Leveraged Impact", scale: "36+ MTPA Combined CO₂ Storage Capacity", partners: "Multi-Operator Anchor JVs", capex: "$40.8B+", directGcp: "$315M – $530M", pullThrough: "$1,400M+", stack: "Captures 60%+ of global CCUS digital platform spend while creating massive pull-through revenue across parent company cloud IT budgets." }
      ],
      commercialStructure: {
